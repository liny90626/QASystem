package org.linky.qasystem.database;
...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        //创建题库基本数据表语句
        String createTableTestLibrary = "CREATE TABLE "
        ...
        String createTableMyErrorQuestion = "CREATE TABLE "
        ...
        db.execSQL(createTableTestLibrary);
        db.execSQL(createTableMyErrorQuestion);
    ...
    public void onDowngrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        db.execSQL("DROP TABLE IF EXISTS " + TABLE_NAME_TEST_LIBRARY);
        db.execSQL("DROP TABLE IF EXISTS " + TABLE_NAME_MY_ERROR_QUESTION);
        onCreate(db);
    }
