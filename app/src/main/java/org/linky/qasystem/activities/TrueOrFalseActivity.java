...
public class TrueOrFalseActivity extends AnalogyExaminationActivity {
    private final static String QUESTION_FILE = "TrueOrFalse/Question.txt";
    private final static String ANALYSIS_FILE = "TrueOrFalse/Analysis.txt";
    private final static String CORRECT_ANSWER_FILE = "TrueOrFalse/CorrectAnswer.txt";
    private final static String OPTIONS_FILE = "TrueOrFalse/Options.txt";
    ...
    protected void loadData() {
        ...
        if (0 != loadQuestionFromAssets(QUESTION_FILE)
            ...
            Toast.makeText(TrueOrFalseActivity.this, R.string.no_data,
    ...
    protected AnswerInfo createAnswerInfo(int questionId) {
        ...
        info.setQuestionType("2");                              // 试题类型, 0单选, 1多选, 2判断
