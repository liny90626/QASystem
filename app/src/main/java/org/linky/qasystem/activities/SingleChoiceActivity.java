...
public class SingleChoiceActivity extends AnalogyExaminationActivity {
    private final static String QUESTION_FILE = "SingleChoice/Question.txt";
    private final static String ANALYSIS_FILE = "SingleChoice/Analysis.txt";
    private final static String CORRECT_ANSWER_FILE = "SingleChoice/CorrectAnswer.txt";
    private final static String OPTIONS_FILE = "SingleChoice/Options.txt";
    ...
    protected void loadData() {
        ...
        if (0 != loadQuestionFromAssets(QUESTION_FILE)
            ...
            Toast.makeText(SingleChoiceActivity.this, R.string.no_data,
    ...
    protected AnswerInfo createAnswerInfo(int questionId) {
        ...
        info.setQuestionType("0");                              // 试题类型, 0单选, 1多选, 2判断
